...
🛡️ Input validation is implemented using **regex** to ensure only numeric integers (positive or negative) are accepted.

---

## ✨ Features

1. **🕹️ Menu-driven interface**
...
2. **🛠️ Open the project** in **Visual Studio** or **VS Code**.
3. **▶️ Build and run** the project.
4. **🖱️ Follow the menu prompts:**
